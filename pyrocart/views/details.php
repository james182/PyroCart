...
div#loader.loading {
    background: url('<?php echo base_url()?>addons/modules/products/img/loading.gif') no-repeat center center;
}
</style>
...
$(document).ready(function(){
    ...
    }).attr('src', BASE_URI+'uploads/products/full/<?php echo $image[0]->productImage?>');
    ...
    <div id="productdetail">
        ...
        <div class="productview">
            ...
            <div class="col1 leftStyle">
                <div id="loader">
                    <img id="myGallery" src="{pyro:url:base}uploads/products/full/<?php echo $image[0]->productImage?>" alt="" title="<?php echo $image[0]->name?>"  />
                </div>
            </div><!--End Col1-->
            ...
            <div class="col2 leftStyle portfolio_image_right">
                ...
                <div class="raw">
                    <img rel='{pyro:url:base}uploads/products/full/<?php echo $img->productImage?>' style="width:64px;height:64px;overflow:hidden;" src="{pyro:url:base}uploads/products/thumbs/<?php echo $img->productImageThumb?>" alt = "" title="<?php echo $img->name?>"/></a>
                </div>
                <?php endforeach;?>
            </div><!--End Col2-->
            ...
            <div class="col3 leftStyle">
                ...
                <?php echo form_open('products/cart/add_cart_item/','id="add_to_cart_form" method="post"');?>
                    <div class="description">
                        <span>Preview:</span> <a href="#">Sample</a><br>
                        <span>Product Code:</span> <?php echo $product->refNo; ?><br>
            ...
            <div class="enlarge"><a class="colorbox_image" href="{pyro:url:base}uploads/products/full/<?php echo $image[0]->productImage?>">Click to enlarge</a></div>
